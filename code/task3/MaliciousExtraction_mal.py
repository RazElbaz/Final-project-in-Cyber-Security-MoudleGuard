...
class MyUnpickler(pickle.Unpickler):
    def find_class(self, module, name):
        ...
        if name == 'MySafeClass':
            print(name)
            # Return the actual class object for MySafeClass
            return MySafeClass
        else:
            print(name)
            # Raise an UnpicklingError for all other classes
            raise pickle.UnpicklingError(f"Class {name} from module {module} is not allowed to be unpickled")
